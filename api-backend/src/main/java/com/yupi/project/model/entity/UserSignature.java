 ...
 */
@TableName(value ="user_signature")
@Data
public class UserSignature implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        UserSignature other = (UserSignature) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getAccessKey() == null ? other.getAccessKey() == null : this.getAccessKey().equals(other.getAccessKey()))
            && (this.getAccessSecret() == null ? other.getAccessSecret() == null : this.getAccessSecret().equals(other.getAccessSecret()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAccessSecret() == null) ? 0 : getAccessSecret().hashCode());
