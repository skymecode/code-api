...
public class UserController {
    ...
    public BaseResponse<JSONObject> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        JSONObject jsonObject = userService.userLogin(userAccount, userPassword, request);
